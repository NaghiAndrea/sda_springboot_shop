...
import com.sda.andreanaghi.webshop.model.*;
import com.sda.andreanaghi.webshop.repository.BillRepository;
import com.sda.andreanaghi.webshop.repository.OrderRepository;
...
public class OrderService {
    ...
    public void save(Customer customer, List<Product> products){
       ...
       // bill.setIssueDate(Timestamp.from(Instant.now().plus(7, ChronoUnit.DAYS)));
        bill.setIssueDate(Timestamp.from(Instant.now().plus(Duration.ofDays(7))));
